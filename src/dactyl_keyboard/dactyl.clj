...
(def keyboard-z-offset 4.5)               ; controls overall height; original=9 with centercol=3; use 16 for centercol=2
...
(def pro-micro-position (map + (key-position 0 2 (wall-locate3 -1 0)) [-6.2 0 -20]))
